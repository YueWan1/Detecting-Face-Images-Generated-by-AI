...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--arch', type=str, default='res50', help='architecture for binary classification. use res50 or mobilev2')
        parser.add_argument('--train_mode',type=int,default=0, help='mode of channel attention mechanism for training. Choose from 0,1,2')
